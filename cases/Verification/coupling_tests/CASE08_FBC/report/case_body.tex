...
\]
The nominal surface-CFL upper bounds are \(0.5\Delta x/0.71\). To keep every requested 10-s-multiple observation time exact, preprocessing selects the largest divisor no greater than that bound, preferring whole seconds when feasible:
\[
