...
The wind-CFL upper-bound step is
\[
...
For the PER-MW variant, the same mask is applied to the observed density and
...
Accumulation plateau error & Relative error of median one-metre-strip density over 155--\SI{195}{m} against the independent reference, using the same valid-reference mask for the PER-MW variant. & \(\le0.10\) for both variants \\
