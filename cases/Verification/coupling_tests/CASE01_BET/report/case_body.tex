...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,height=0.68\textheight,keepaspectratio]{../figures/emission_time_resolution.pdf}
...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.78\textwidth,height=0.42\textheight,keepaspectratio]{../figures/emission_time_error.pdf}
