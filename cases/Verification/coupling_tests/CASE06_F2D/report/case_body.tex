...
\midrule
Perimeter completeness & Unique transient \path{phi} raster selected within \SI{2}{s} of 30, 60, 90, and \SI{120}{s}. & 4 of 4 target times \\
...
Accumulation / ignition & Eulerian / direct & tested implementation path\\
...
\Metric{completedperimetertimess}~s. Exact filenames are recorded in
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,height=0.55\textheight,keepaspectratio]{../figures/two_dimensional_fireline_evolution.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth,height=0.46\textheight,keepaspectratio]{../figures/two_dimensional_transport_fields.pdf}
