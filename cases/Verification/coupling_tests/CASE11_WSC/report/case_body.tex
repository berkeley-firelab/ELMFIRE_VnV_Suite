...
Maximum time & \SI{6000}{s} & \SI{3500}{s}\\
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{surface_coupled_reference.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{surface_coupling_comparison.pdf}
...
reported as \emph{NOT EVALUATED}, never as a pass.
...
Earlier, more synchronized ignition together with persistent load variation is the expected coupled signature: surface spread mitigates ignition timing distortion without changing the cell-local firebrand accumulation field.
