...
% ==== Case metadata (edit as needed) ====
\newcommand{\CaseID}{mc\_toa\_uniform\_mask}
\newcommand{\CaseTitle}{Monte Carlo Time-of-Arrival (ToA) under Uniform Ignition Masks}
\newcommand{\CaseOwner}{Yiren Qin}
\newcommand{\CaseVersion}{v0.1}
\newcommand{\CaseDate}{\today}

\title{ELMFIRE Verification Case\\\CaseTitle}
\author{\CaseOwner}
\date{\CaseDate\ (\CaseVersion)}
...
\section{Expected Statistics and Reasoning}
